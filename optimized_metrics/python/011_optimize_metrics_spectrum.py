...
###
### This script optimizes the weigths of a Gaussian Kernel on the auditory spectrum in order to fit with the human dissimilarity ratings
...
###
### This script replicates the results of the section "Optimized metrics simulating human dissimilarity ratings" for the Auditory Spectrum
### and Auditory Spectrum decimated
###
...
def run(tsp=None, rs=None):
    ...
    args = {
        ...
        'log_foldername': './out_folder_spectrum/', # output folder
        'reduce_strf': 'avg_time_avg_scale',
        # type of averaging
...
if __name__ == '__main__':
    ...
    run(tsp=['Barthet2010','Grey1977','Grey1978','Iverson1993_Onset','Iverson1993_Remainder','Iverson1993_Whole', 'McAdams1995','Patil2012_A3',
        ...
        rs=['auditory_spectrum']) # representations to be used