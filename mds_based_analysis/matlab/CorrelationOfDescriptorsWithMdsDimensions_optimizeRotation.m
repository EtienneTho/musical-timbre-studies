function [resultsStruct] = CorrelationOfDescriptorsWithMdsDimensions_optimizeRotation(soundPath, ext , dissimilaritiesFile, AT, nbDimMDS, typeOfCorrelation,rotation)
...
% Rotation of the MDS
if rotation == 0
    [~,MDS_rot] = procrustes(descriptors(:,1:2),MDS(:,1:2)) ;
